# Harden Report: HODGE-322

## Validation Results
**Date**: 10/3/2025, 5:35:33 PM
...
(node:57374) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
(node:57370) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
(node:57373) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
(node:57372) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
ℹ️  Created project_management.md with project plan
 ...
 ✓ src/commands/hodge-319.4.smoke.test.ts (2 tests) 1714ms
   ✓ HODGE-319.4 - Phase-Specific Context.json Elimination > [smoke] build command should NOT create phase-specific context.json  1658ms
stdout | src/commands/ship.integration.test.ts > Ship Command - Integration Tests > [integration] should complete full ship workflow with pre-approved message
...
1. auto-feature-2-2025-10-04T00-35-09 (5 minutes ago)
   Feature: feature-2, Mode: explore
2. auto-feature-2-2025-10-04T00-29-49 (6 minutes ago)
   Feature: feature-2, Mode: explore
3. auto-feature-2-2025-10-04T00-28-11 (7 minutes ago)
   Feature: feature-2, Mode: explore
4. auto-feature-2-2025-10-04T00-26-08 (9 minutes ago)
   Feature: feature-2, Mode: explore
5. auto-feature-2-2025-10-04T00-25-00 (15 minutes ago)
   Feature: feature-2, Mode: explore
...
**PM Issue**: HODGE-001
**Type**: general
**Created**: 2025-10-04T00:35:14.125Z
...
ℹ️  Created project_management.md with project plan
 ...
 ✓ src/lib/pm/pm-hooks.smoke.test.ts (10 tests) 1224ms
...
Failed to load interaction state: SyntaxError: Expected property name or '}' in JSON at position 2 (line 1 column 3)
    ...
    at ShipCommand.execute (/Users/michaelkelly/Projects/hodge/src/commands/ship.ts:189:29)
...
stdout | src/commands/plan.test.ts > PlanCommand - Smoke Tests > [smoke] should accept --create-pm flag without crashing
✓ Created PM issue: 2b0028cd-c48d-46fa-8e30-fa4fc6292bbe
...
✓ Added TEST-005 to project management tracking
 ...
 ✓ src/commands/plan.test.ts (12 tests) 2158ms
   ✓ PlanCommand - Smoke Tests > [smoke] should accept --create-pm flag without crashing  1755ms
stdout | src/lib/pm/local-pm-adapter-unified.smoke.test.ts > LocalPMAdapter Unified Architecture Smoke Tests > [smoke] should search features through searchIssues
...
📝 Creating git commit...
 ...
 ✓ src/commands/explore.new-style.test.ts (12 tests) 2161ms
   ✓ ExploreCommand > Acceptance Tests > [acceptance] should support complete exploration workflow  512ms
   ✓ ExploreCommand > ExploreCommand (Real FS) > [integration] should work with real file system  514ms
...
✓ Updated TEST-010 status to: hardening
 ...
 ✓ src/lib/pm/local-pm-adapter-unified.smoke.test.ts (12 tests) 1661ms
...
3. auto-feature-2-2025-10-04T00-28-11 (7 minutes ago)
   Feature: feature-2, Mode: explore
4. auto-feature-2-2025-10-04T00-26-08 (10 minutes ago)
   Feature: feature-2, Mode: explore
5. auto-feature-2-2025-10-04T00-25-00 (15 minutes ago)
   Feature: feature-2, Mode: explore
...
stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should save and load a session successfully
✓ Save complete in 127ms

stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should save and load a session successfully
✓ Session saved successfully
  Name: integration-test-save
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-9481d73ef7e57a16/.hodge/saves/integration-test-save
  Time: 127ms
  Type: Full save
...
Ship record saved to: .hodge/features/test-feature/ship
 ...
 ✓ src/commands/ship.integration.test.ts (5 tests) 2984ms
   ✓ Ship Command - Integration Tests > [integration] should complete full ship workflow with pre-approved message  696ms
   ✓ Ship Command - Integration Tests > [integration] should fallback to default message when no state exists  362ms
   ✓ Ship Command - Integration Tests > [integration] should handle corrupted state gracefully and fallback  647ms
   ✓ Ship Command - Integration Tests > [integration] should create ship record and release notes  678ms
   ✓ Ship Command - Integration Tests > [integration] should skip push to protected branch without prompting  598ms
...
✓ Session saved successfully
  ...
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-08870dd2f492478e/.hodge/saves/minimal-integration-test
  Time: 64ms
...
✓ Session saved successfully
  Name: list-test-1
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-2acd32c9e16ae731/.hodge/saves/list-test-1
  Time: 35ms
  Type: Full save

 ✓ src/lib/esm-config.integration.test.ts (6 tests) 4797ms
   ✓ ESM Configuration Integration - HODGE-318 > [integration] should import ESM modules correctly throughout the codebase  398ms
   ✓ ESM Configuration Integration - HODGE-318 > [integration] should run vitest without ERR_REQUIRE_ESM errors  4312ms
...
✓ Session saved successfully
  Name: list-test-2
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-2acd32c9e16ae731/.hodge/saves/list-test-2
  Time: 34ms
  Type: Full save
...
✓ Session saved successfully
  Name: list-test-3
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-2acd32c9e16ae731/.hodge/saves/list-test-3
  Time: 28ms
  Type: Minimal (manifest only)
...
Context loaded. Ready to work!
 ...
 ✓ src/commands/context.smoke.test.ts (8 tests) 4667ms
   ✓ ContextCommand - HODGE-297 Enhanced Loading > [smoke] should execute context command without crashing  1550ms
   ✓ ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should use session feature for mode detection when session exists  658ms
   ✓ ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should fall back to general when no session exists  1612ms
   ✓ ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should detect build mode correctly for session feature  730ms
...
✓ Session saved successfully
  Name: old-save
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-33be1c5b6de93cc1/.hodge/saves/old-save
  Time: 39ms
  Type: Full save
...
✓ Session saved successfully
  Name: recent-save
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-33be1c5b6de93cc1/.hodge/saves/recent-save
  Time: 33ms
  Type: Full save
...
✓ Session saved successfully
  ...
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-116c099c05bc299d/.hodge/saves/metadata-test-save
  Time: 48ms
  Type: Full save
...
✓ Updated TRANSITION-001 status to: shipped
 ...
 ✓ src/commands/save-load.integration.test.ts (5 tests) 1529ms
   ✓ Save/Load Commands [integration] > should save and load a session successfully  388ms
   ✓ Save/Load Commands [integration] > should list saves correctly  345ms
   ✓ Save/Load Commands [integration] > should load most recent save automatically  300ms
 ✓ src/test/commonjs-compatibility.smoke.test.ts (3 tests) 785ms
   ✓ CommonJS Compatibility [smoke] > should import inquirer without warnings in CommonJS  633ms
...
✓ Updated URL-001 status to: shipped
 ...
 ✓ src/commands/ship-commit-messages.integration.test.ts (4 tests) 699ms
...
✓ Updated NONEXISTENT-002 status to: building
 ...
 ✓ src/lib/pm/local-pm-adapter-unified.integration.test.ts (7 tests) 901ms
...
📂 Showing status for HODGE-322 from session

📊 Status for feature: HODGE-322
...
Next Step:
  ...
  hodge decide "Your decision here" --feature HODGE-322

 ✓ src/lib/logger.smoke.test.ts (9 tests) 1053ms
   ✓ [smoke] Logger > [smoke] should create LogRotator without crashing  818ms
...
⚠️  No work found for this feature.
 ...
 ✓ src/commands/status.smoke.test.ts (6 tests) 737ms
 ✓ src/lib/id-manager.test.ts (27 tests) 772ms
(node:57943) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/commands/ship.smoke.test.ts (5 tests) 6704ms
   ✓ Ship Command - Smoke Tests > [smoke] should not crash when executed without state  1501ms
   ✓ Ship Command - Smoke Tests > [smoke] should detect and use pre-approved message from state  778ms
   ✓ Ship Command - Smoke Tests > [smoke] should be completely non-interactive  2457ms
   ✓ Ship Command - Smoke Tests > [smoke] should handle corrupted state files gracefully  871ms
   ✓ Ship Command - Smoke Tests > [smoke] should be non-interactive by default (no prompts allowed)  1094ms
...
(node:57937) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
(node:57951) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/test/ship-lessons.smoke.test.ts (5 tests) 781ms
   ✓ [smoke] Ship Lessons Generation > [smoke] ship command should have generateLessonsDraft method  764ms
(node:57950) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/commands/ship-clean-tree.smoke.test.ts (3 tests) 665ms
   ✓ ship command - clean working tree > [smoke] should have rollback functions defined  661ms
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759538118719-42vnrj/.hodge/features/HODGE-301/decisions.md
  Feature: HODGE-301
...
(node:57963) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
stdout | src/lib/pm/integration.test.ts > PM Integration Tests > [integration] should handle concurrent updates gracefully
ℹ️  Created project_management.md with project plan

 ✓ src/commands/ship-clean-tree.integration.test.ts (4 tests) 637ms
   ✓ ship command integration - HODGE-220 > [integration] should have backup and restore functions integrated  617ms
 ✓ test/pm-integration.smoke.test.ts (13 tests) 348ms
...
stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should create auto-save when switching features
📦 Auto-saved: old-feature → /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759538118853-11f881e6/.hodge/saves/auto-old-feature-2025-10-04T00-35-18 (83ms)
...
stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should preserve context in auto-save
📦 Auto-saved: old-feature → /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759538118944-24745d27/.hodge/saves/auto-old-feature-2025-10-04T00-35-18 (43ms)
...
✓ Updated project management tracking
 ...
 ✓ src/lib/pm/integration.test.ts (7 tests) 511ms
stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should use auto- prefix for save names
✓ Save complete in 60ms

stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should use auto- prefix for save names
📦 Auto-saved: test-feature → /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759538119000-16d475a4/.hodge/saves/auto-test-feature-2025-10-04T00-35-19 (60ms)

stderr | src/lib/__tests__/auto-save.test.ts > AutoSave > Error Handling > [integration] should continue even if save fails
Auto-save failed for old-feature: EACCES: permission denied, mkdir '/var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759538119102-9f6c361c/.hodge/saves/auto-old-feature-2025-10-04T00-35-19'

 ✓ src/lib/__tests__/auto-save.test.ts (10 tests) 490ms
 ✓ src/test/documentation-hierarchy.integration.test.ts (2 tests) 339ms
(node:58030) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
✓ Added TEST-001 to project management tracking
 ...
 ✓ src/lib/metadata-clarity.smoke.test.ts (5 tests) 316ms
stdout | src/test/pm-hooks.smoke.test.ts > [smoke] PMHooks should handle missing configuration gracefully
✓ Updated TEST-001 status to: building
...
✓ Updated project management tracking
 ...
 ✓ src/test/standards-enforcement.integration.test.ts (2 tests) 376ms
...
ℹ️  Created project_management.md with project plan
 ...
 ✓ src/test/pm-hooks.smoke.test.ts (5 tests) 485ms
   ✓ [smoke] PMHooks should handle missing configuration gracefully  390ms
stdout | src/lib/pm/pm-hooks.integration.test.ts > PMHooks Integration Tests > [integration] should respect custom status mappings
✓ Added CUSTOM-STATUS to project management tracking

 ✓ src/lib/pm/pm-hooks.integration.test.ts (5 tests) 112ms
 ✓ src/lib/install-hodge-way.test.ts (6 tests) 322ms
(node:58059) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
(node:58043) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/lib/config-cleanup.smoke.test.ts (5 tests) 406ms
   ✓ Config Cleanup Smoke Tests > [smoke] should create hodge.json during init if PM tool selected  379ms
 ✓ src/lib/config-defaults.smoke.test.ts (5 tests) 274ms
...
✓ Updated project management tracking
 ...
 ✓ src/lib/pm/pm-hooks-integration.test.ts (6 tests) 217ms
(node:58058) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
✓ Updated HODGE-006 status to: shipped
 ...
 ✓ src/commands/load.test.ts (4 tests) 102ms
stdout | src/commands/explore-timing-fix.integration.test.ts > [integration] Explore Command Timing Fix > [integration] multiple explores complete successfully
🔍 Entering Explore Mode (Enhanced)
Feature: feature-2
...
✓ Updated TEST-003 status to: building
 ...
 ✓ src/commands/explore-timing-fix.integration.test.ts (2 tests) 256ms
...
✓ Updated TEST-005 status to: shipped
 ...
 ✓ src/lib/pm/local-pm-adapter.test.ts (10 tests) 351ms
 ✓ src/lib/hodge-md-generator.test.ts (12 tests) 25ms
(node:58111) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
stdout | test/pm-integration.integration.test.ts > [integration] PM integration: decide command creates issues after decisions
📝 Recording Decision

(node:58117) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
stdout | test/pm-integration.integration.test.ts > [integration] PM integration: decide command creates issues after decisions
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759538121285/.hodge/features/TEST-001/decisions.md
  Feature: TEST-001

stdout | test/pm-integration.integration.test.ts > [integration] PM integration: decide command creates issues after decisions
  Total decisions: 1

(node:58129) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
Next Steps:
 ...
 ✓ src/lib/config-manager.integration.test.ts (6 tests) 74ms
 ✓ src/test/decide-command.smoke.test.ts (6 tests) 5ms
 ✓ test/pm-integration.integration.test.ts (6 tests) 538ms
...
Warning: Failed to load context.json: SyntaxError: Expected property name or '}' in JSON at position 2 (line 1 column 3)
 ...
 ✓ src/test/context-aware-commands.test.ts (8 tests) 129ms
 ✓ src/lib/__tests__/context-manager.test.ts (9 tests) 178ms
 ✓ src/commands/plan.smoke.test.ts (11 tests) 552ms
 ✓ scripts/create-test-workspace.test.ts (34 tests | 3 skipped) 132ms
...
🚀 Next steps:
 ...
 ✓ src/commands/init.test.ts (5 tests) 37ms
 ✓ src/lib/pm/github-adapter.smoke.test.ts (4 tests) 93ms
 ✓ src/lib/cache-manager.test.ts (28 tests) 131ms
 ✓ src/lib/claude-commands.smoke.test.ts (13 tests) 115ms
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759538122750/.hodge/features/TEST-001/decisions.md
  Feature: TEST-001
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759538122828/.hodge/decisions.md
  Total decisions: 1
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759538122832/.hodge/features/TEST-002/decisions.md
  Feature: TEST-002
...
✗ Error: Feature directory does not exist
  Expected: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759538122840/.hodge/features/NONEXISTENT
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759538122844/.hodge/features/TEST-003/decisions.md
  Feature: TEST-003

stdout | src/commands/decide.smoke.test.ts > Decide Command --feature Flag (HODGE-313) > [smoke] Feature decisions file uses correct template format
  Total decisions: 1

 ✓ src/commands/decide.smoke.test.ts (5 tests) 106ms
 ✓ src/lib/detection.test.ts (37 tests) 99ms
stdout | src/lib/__tests__/feature-spec-loader.test.ts > [unit] FeatureSpecLoader > loadSpec > should load a valid YAML spec
✓ Loaded feature spec from /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-7j5ysc/test-spec.yaml
...
✓ Loaded feature spec from /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-99r9p/minimal-spec.yaml

 ✓ src/lib/ship-service.test.ts (17 tests) 159ms
 ✓ src/lib/__tests__/feature-spec-loader.test.ts (15 tests) 446ms
 ✓ src/test/documentation-hierarchy.smoke.test.ts (4 tests) 4ms
 ✓ src/test/test-isolation.smoke.test.ts (3 tests) 4ms
 ✓ scripts/cross-platform.test.ts (25 tests) 209ms
 ✓ src/commands/ship-commit-messages.smoke.test.ts (5 tests) 137ms
 ✓ src/lib/hodge-319.3.smoke.test.ts (14 tests) 8ms
 ✓ src/lib/structure-generator.test.ts (27 tests) 84ms
(node:58203) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/lib/pm/env-validator.test.ts (13 tests) 35ms
 ✓ src/commands/ship-lessons.test.ts (5 tests) 158ms
...
[90m    at processTicksAndRejections (node:internal/process/task_queues:105:5)[39m
 ...
 ✓ src/commands/save.test.ts (4 tests) 42ms
 ✓ src/test/commonjs-compatibility.integration.test.ts (6 tests) 32ms
 ✓ test/commands/hodge-context-loading.test.ts (4 tests) 222ms
 ...
 ✓ src/lib/pm/index.test.ts (10 tests) 77ms
 ✓ src/lib/pm/pm-adapter.test.ts (14 tests) 10ms
 ✓ src/lib/claude-commands-conversational.smoke.test.ts (6 tests) 20ms
 ✓ src/lib/standards-validator.test.ts (7 tests) 4ms
 ✓ src/lib/esm-config.smoke.test.ts (5 tests) 9ms
 ✓ src/commands/hodge-319.2.smoke.test.ts (10 tests) 30ms
...
(node:58297) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/commands/explore.hodge053.test.ts (11 tests) 21ms
(node:58310) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
(node:58334) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
(node:58331) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ↓ src/commands/explore.test.ts (6 tests | 6 skipped)
 ✓ scripts/sync-claude-commands.test.ts (6 tests) 16101ms
   ✓ sync-claude-commands > [smoke] should generate valid TypeScript  2352ms
   ✓ sync-claude-commands > [smoke] should generate properly formatted code  4347ms
   ✓ sync-claude-commands > [smoke] should complete within reasonable time  1920ms
   ✓ sync-claude-commands > [smoke] should preserve command content  2002ms
   ✓ sync-claude-commands > [smoke] should generate consistent output across runs  4528ms
   ✓ sync-claude-commands > [smoke] should handle prettier formatting gracefully  951ms

 Test Files  83 passed | 5 skipped (88)
      Tests  738 passed | 41 skipped (779)
   Start at  17:35:10
   Duration  17.36s (transform 3.94s, setup 0ms, collect 27.65s, tests 62.37s, environment 25ms, prepare 18.93s)
...
/Users/michaelkelly/Projects/hodge/src/commands/ship.ts
  214:22  warning  Prefer using nullish coalescing operator (`??`) instead of a logical or (`||`), as it is a safer operator  @typescript-eslint/prefer-nullish-coalescing
  421:65  warning  Prefer using nullish coalescing operator (`??`) instead of a logical or (`||`), as it is a safer operator  @typescript-eslint/prefer-nullish-coalescing
  455:17  warning  Prefer using nullish coalescing operator (`??`) instead of a logical or (`||`), as it is a safer operator  @typescript-eslint/prefer-nullish-coalescing
