# Harden Report: HODGE-328

## Validation Results
**Date**: 10/4/2025, 5:56:36 PM
...
(node:72256) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
(node:72253) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
(node:72248) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
(node:72255) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
**PM Issue**: HODGE-001
**Type**: general
**Created**: 2025-10-05T00:56:15.366Z
...
1. auto-feature-2-2025-10-05T00-56-10 (0 minutes ago)
   Feature: feature-2, Mode: explore
2. auto-HODGE-327.1-2025-10-05T00-35-46 (31 minutes ago)
   Feature: HODGE-327.1, Mode: ship
3. auto-feature-2-2025-10-05T00-24-35 (32 minutes ago)
   Feature: feature-2, Mode: explore
4. auto-feature-2-2025-10-05T00-23-45 (32 minutes ago)
   Feature: feature-2, Mode: explore
5. auto-feature-2-2025-10-05T00-23-04 (1 hour ago)
   Feature: feature-2, Mode: explore
...
📚 Loading Hodge Context
 ...
 ✓ src/lib/pm/pm-hooks.smoke.test.ts (10 tests) 1808ms
   ✓ PM Hooks Smoke Tests > [smoke] should handle build hook  306ms
   ✓ PM Hooks Smoke Tests > [smoke] should update local PM tracking  452ms
stdout | src/commands/context.smoke.test.ts > ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should use session feature for mode detection when session exists
✓ Generated fresh HODGE.md

 ✓ src/commands/hodge-319.4.smoke.test.ts (2 tests) 2930ms
   ✓ HODGE-319.4 - Phase-Specific Context.json Elimination > [smoke] build command should NOT create phase-specific context.json  2813ms
...
✓ Added HODGE-001 to project management tracking
 ...
 ✓ src/commands/explore.new-style.test.ts (12 tests) 2373ms
   ✓ ExploreCommand > Integration Tests > [integration] should create exploration structure  362ms
   ✓ ExploreCommand > Acceptance Tests > [acceptance] should support complete exploration workflow  703ms
...
Ship record saved to: .hodge/features/test-feature/ship
 ...
 ✓ src/commands/ship.integration.test.ts (5 tests) 3203ms
   ✓ Ship Command - Integration Tests > [integration] should complete full ship workflow with pre-approved message  800ms
   ✓ Ship Command - Integration Tests > [integration] should fallback to default message when no state exists  469ms
   ✓ Ship Command - Integration Tests > [integration] should handle corrupted state gracefully and fallback  505ms
   ✓ Ship Command - Integration Tests > [integration] should create ship record and release notes  760ms
   ✓ Ship Command - Integration Tests > [integration] should skip push to protected branch without prompting  665ms
stdout | src/commands/context.smoke.test.ts > ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should use session feature for mode detection when session exists
...
stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should save and load a session successfully
✓ Save complete in 140ms

stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should save and load a session successfully
✓ Session saved successfully
  Name: integration-test-save
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-0aab173374443aa2/.hodge/saves/integration-test-save
  Time: 142ms
  Type: Full save
...
ℹ️  Created project_management.md with project plan
 ...
 ✓ src/lib/esm-config.integration.test.ts (6 tests) 4969ms
   ✓ ESM Configuration Integration - HODGE-318 > [integration] should run vitest without ERR_REQUIRE_ESM errors  4602ms
...
stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should handle minimal saves efficiently
✓ Minimal save complete in 54ms

stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should handle minimal saves efficiently
✓ Session saved successfully
  Name: minimal-integration-test
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-d5b3a772295368e3/.hodge/saves/minimal-integration-test
  Time: 54ms
...
stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should list saves correctly
✓ Save complete in 124ms

stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should list saves correctly
✓ Session saved successfully
  Name: list-test-1
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-2003e3fda1fc3f0f/.hodge/saves/list-test-1
  Time: 124ms
  Type: Full save
...
✓ Session saved successfully
  Name: list-test-2
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-2003e3fda1fc3f0f/.hodge/saves/list-test-2
  Time: 35ms
  Type: Full save
...
stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should list saves correctly
✓ Minimal save complete in 33ms

stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should list saves correctly
✓ Session saved successfully
  Name: list-test-3
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-2003e3fda1fc3f0f/.hodge/saves/list-test-3
  Time: 33ms
  Type: Minimal (manifest only)
...
✓ Added TEST-006 to project management tracking
 ...
 ✓ src/commands/ship-commit-messages.integration.test.ts (4 tests) 780ms
...
✓ Session saved successfully
  Name: old-save
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-0fac5ef7b27a59f7/.hodge/saves/old-save
  Time: 48ms
  Type: Full save
...
📂 Showing status for HODGE-328 from session

📊 Status for feature: HODGE-328
...
Next Step:
  ...
  hodge decide "Your decision here" --feature HODGE-328

 ✓ src/lib/pm/local-pm-adapter-unified.smoke.test.ts (12 tests) 1458ms
stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should load most recent save automatically
...
✓ Session saved successfully
  Name: recent-save
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-0fac5ef7b27a59f7/.hodge/saves/recent-save
  Time: 32ms
  Type: Full save
...
✓ Generated fresh HODGE.md
 ...
 ✓ src/lib/id-manager.test.ts (27 tests) 1001ms
   ✓ IDManager > performance > should complete operations within 500ms  502ms
stdout | src/commands/plan.test.ts > PlanCommand - Smoke Tests > [smoke] should accept --create-pm flag without crashing
✓ Created PM issue: 9fed2745-8be1-408c-ba4a-3e6adf32e58b
...
Next Steps:
 ...
 ✓ src/commands/plan.test.ts (12 tests) 5197ms
   ✓ PlanCommand - Smoke Tests > [smoke] should accept --create-pm flag without crashing  4746ms
stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should preserve session metadata through save/load cycle
...
✓ Session saved successfully
  ...
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-cb019491d38935ec/.hodge/saves/metadata-test-save
  Time: 42ms
  Type: Full save
...
Quick Actions:
 ...
 ✓ src/commands/save-load.integration.test.ts (5 tests) 1863ms
   ✓ Save/Load Commands [integration] > should save and load a session successfully  517ms
   ✓ Save/Load Commands [integration] > should list saves correctly  455ms
   ✓ Save/Load Commands [integration] > should load most recent save automatically  360ms
...
⚠️  No work found for this feature.
 ...
 ✓ src/commands/status.smoke.test.ts (6 tests) 815ms
...
Context loaded. Ready to work!
 ...
 ✓ src/commands/context.smoke.test.ts (8 tests) 6673ms
   ✓ ContextCommand - HODGE-297 Enhanced Loading > [smoke] should execute context command without crashing  2509ms
   ✓ ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should use session feature for mode detection when session exists  1799ms
   ✓ ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should fall back to general when no session exists  1404ms
   ✓ ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should detect build mode correctly for session feature  869ms
...
✓ Loaded feature spec from /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-usgrrf/test-spec.yaml
...
✓ Loaded feature spec from /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-akuz05/minimal-spec.yaml
...
✓ Updated CONCURRENT-010 status to: building
 ...
 ✓ src/lib/__tests__/feature-spec-loader.test.ts (15 tests) 272ms
...
(node:72768) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
stdout | src/lib/pm/local-pm-adapter-unified.integration.test.ts > LocalPMAdapter Unified Architecture Integration Tests > [integration] should handle state transitions correctly
...
✓ Updated TRANSITION-001 status to: shipped
 ...
 ✓ src/lib/metadata-clarity.smoke.test.ts (5 tests) 638ms
   ✓ Metadata Clarity Smoke Tests > [smoke] should have explanatory header in project-meta.json  377ms
...
[90m    at processTicksAndRejections (node:internal/process/task_queues:105:5)[39m
 ...
 ✓ src/commands/ship.smoke.test.ts (5 tests) 7634ms
   ✓ Ship Command - Smoke Tests > [smoke] should not crash when executed without state  1597ms
   ✓ Ship Command - Smoke Tests > [smoke] should detect and use pre-approved message from state  605ms
   ✓ Ship Command - Smoke Tests > [smoke] should be completely non-interactive  3322ms
   ✓ Ship Command - Smoke Tests > [smoke] should handle corrupted state files gracefully  916ms
   ✓ Ship Command - Smoke Tests > [smoke] should be non-interactive by default (no prompts allowed)  1192ms
...
✓ Updated NONEXISTENT-002 status to: building
 ...
 ✓ src/lib/pm/local-pm-adapter-unified.integration.test.ts (7 tests) 1223ms
   ✓ LocalPMAdapter Unified Architecture Integration Tests > [integration] should properly serialize concurrent operations  325ms
 ✓ src/lib/pattern-learner.test.ts (14 tests) 115ms
...
✓ Updated project management tracking
 ...
 ✓ src/test/commonjs-compatibility.smoke.test.ts (3 tests) 1473ms
   ✓ CommonJS Compatibility [smoke] > should import inquirer without warnings in CommonJS  1275ms
 ✓ src/lib/pm/pm-hooks-integration.test.ts (6 tests) 595ms
   ✓ PM Hooks Integration > [smoke] PM hooks should handle missing configuration gracefully  342ms
...
✓ Added TEST-FEATURE to project management tracking
 ...
 ✓ src/lib/config-manager.integration.test.ts (6 tests) 446ms
...
(node:72885) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/lib/pm/integration.test.ts (7 tests) 1156ms
   ✓ PM Integration Tests > [integration] should create PM tracking on explore  385ms
   ✓ PM Integration Tests > [integration] should track feature history correctly  319ms
(node:72895) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
(node:72894) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/commands/ship-clean-tree.integration.test.ts (4 tests) 1055ms
   ✓ ship command integration - HODGE-220 > [integration] should have backup and restore functions integrated  1026ms
 ✓ src/test/documentation-hierarchy.integration.test.ts (2 tests) 672ms
   ✓ Documentation Hierarchy Integration Tests > [integration] documentation hierarchy should support learning loop  467ms
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759625782810/.hodge/features/TEST-001/decisions.md
  Feature: TEST-001

stdout | test/pm-integration.integration.test.ts > [integration] PM integration: decide command creates issues after decisions
  Total decisions: 1

 ✓ src/test/standards-enforcement.integration.test.ts (2 tests) 603ms
   ✓ Standards Enforcement Integration Tests > [integration] slash command templates should work together for progressive enforcement  408ms
...
Next Steps:
 ...
 ✓ src/lib/config-defaults.smoke.test.ts (5 tests) 733ms
   ✓ Config Defaults Smoke Tests > [smoke] should create comprehensive hodge.json on init  455ms
 ✓ src/lib/config-cleanup.smoke.test.ts (5 tests) 839ms
 ✓ test/pm-integration.integration.test.ts (6 tests) 672ms
   ✓ [integration] PM integration: decide command creates issues after decisions  319ms
(node:72905) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
Exploration saved to: .hodge/features/feature-2/explore
 ...
 ✓ src/commands/explore-timing-fix.integration.test.ts (2 tests) 476ms
...
Warning: Failed to load context.json: SyntaxError: Expected property name or '}' in JSON at position 2 (line 1 column 3)
 ...
 ✓ src/lib/__tests__/context-manager.test.ts (9 tests) 221ms
 ✓ src/lib/session-manager.test.ts (11 tests) 408ms
...
stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should create auto-save when switching features
📦 Auto-saved: old-feature → /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759625784254-ed78ed3a/.hodge/saves/auto-old-feature-2025-10-05T00-56-24 (82ms)

stdout | src/lib/pm/local-pm-adapter.test.ts > LocalPMAdapter > [smoke] should include project plan in template
ℹ️  Created project_management.md with project plan

(node:72958) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
✓ Save complete in 40ms

stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should preserve context in auto-save
📦 Auto-saved: old-feature → /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759625784341-1646e123/.hodge/saves/auto-old-feature-2025-10-05T00-56-24 (40ms)
...
(node:72969) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
(node:72976) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
stdout | src/lib/pm/local-pm-adapter.test.ts > LocalPMAdapter > [smoke] should not duplicate features
✓ Added TEST-004 to project management tracking
...
ℹ️  Created project_management.md with project plan
 ...
 ✓ src/lib/pm/local-pm-adapter.test.ts (10 tests) 348ms
stdout | src/lib/pm/pm-hooks.integration.test.ts > PMHooks Integration Tests > [integration] should properly integrate with configuration loading
✓ Added TEST-001 to project management tracking

stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should use auto- prefix for save names
✓ Save complete in 223ms

stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should use auto- prefix for save names
📦 Auto-saved: test-feature → /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759625784385-65d654bd/.hodge/saves/auto-test-feature-2025-10-05T00-56-24 (225ms)
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759625784615-uw41j5/.hodge/features/HODGE-301/decisions.md
  Feature: HODGE-301
...
✓ Updated WORKFLOW-TEST status to: building
 ...
 ✓ src/test/pm-hooks.smoke.test.ts (5 tests) 335ms
stdout | src/lib/pm/pm-hooks.integration.test.ts > PMHooks Integration Tests > [integration] should track features through entire workflow
✓ Updated WORKFLOW-TEST status to: hardening

stderr | src/lib/__tests__/auto-save.test.ts > AutoSave > Error Handling > [integration] should continue even if save fails
Auto-save failed for old-feature: EACCES: permission denied, mkdir '/var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759625784646-5e8c7431/.hodge/saves/auto-old-feature-2025-10-05T00-56-24'

 ✓ src/lib/__tests__/auto-save.test.ts (10 tests) 477ms
stdout | src/lib/pm/pm-hooks.integration.test.ts > PMHooks Integration Tests > [integration] should track features through entire workflow
✓ Updated WORKFLOW-TEST status to: shipped
...
✓ Added CONCURRENT-1 to project management tracking
 ...
 ✓ test/pm-integration.smoke.test.ts (13 tests) 194ms
stdout | src/lib/pm/pm-hooks.integration.test.ts > PMHooks Integration Tests > [integration] should handle concurrent feature updates
✓ Added CONCURRENT-2 to project management tracking
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759625784750/.hodge/features/TEST-001/decisions.md
  Feature: TEST-001
...
✓ Added CUSTOM-STATUS to project management tracking
 ...
 ✓ src/lib/pm/pm-hooks.integration.test.ts (5 tests) 252ms
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759625784965/.hodge/decisions.md
  Total decisions: 1
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759625785031/.hodge/features/TEST-002/decisions.md
  Feature: TEST-002
...
✗ Error: Feature directory does not exist
  Expected: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759625785046/.hodge/features/NONEXISTENT

  Please run /explore first to create the feature structure.

 ✓ src/lib/install-hodge-way.test.ts (6 tests) 404ms
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759625785052/.hodge/features/TEST-003/decisions.md
  Feature: TEST-003

stdout | src/commands/decide.smoke.test.ts > Decide Command --feature Flag (HODGE-313) > [smoke] Feature decisions file uses correct template format
  Total decisions: 1

(node:72982) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/commands/decide.smoke.test.ts (5 tests) 484ms
 ✓ src/commands/ship-clean-tree.smoke.test.ts (3 tests) 696ms
   ✓ ship command - clean working tree > [smoke] should have rollback functions defined  689ms
(node:73029) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/commands/ship-commit-messages.smoke.test.ts (5 tests) 244ms
 ✓ src/commands/load.test.ts (4 tests) 182ms
...
(Use `node --trace-deprecation ...` to show where the warning was created)
 ...
 ✓ src/lib/pm/github-adapter.smoke.test.ts (4 tests) 81ms
 ✓ src/commands/plan.smoke.test.ts (11 tests) 223ms
 ✓ test/commands/hodge-context-loading.test.ts (4 tests) 144ms
 ✓ src/commands/hodge-326.smoke.test.ts (10 tests) 62ms
 ✓ src/lib/cache-manager.test.ts (28 tests) 82ms
...
❌ Error: File not found: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/does-not-exist-1759625786479.ts
...
**File**: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759625786483/test.ts
...
1. Analyze /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759625786483/test.ts using Default Code Quality profile
...
Note: Full AI analysis integration coming in build completion.
 ...
 ✓ src/commands/review.smoke.test.ts (8 tests) 123ms
...
**File**: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-review-test-ad5a57d934e862bb/valid.ts
...
To complete the review, the slash command template will:
1. Analyze /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-review-test-ad5a57d934e862bb/valid.ts using Test Quality Profile profile
...
❌ Profile not found: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-review-noprofile-a9c2724fced186b4/.hodge/review-profiles/default.yml
❌ Review failed: process.exit called

 ✓ src/lib/claude-commands.smoke.test.ts (17 tests) 193ms
...
**File**: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-review-test-d425dc00a8331c2b/content-test.ts
**Profile**: Test Quality Profile
**Standards Loaded**: ✓
**Principles Loaded**: ✓
**Patterns**: 1 files
...
To complete the review, the slash command template will:
1. Analyze /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-review-test-d425dc00a8331c2b/content-test.ts using Test Quality Profile profile
2. Check against 1 lessons learned
3. Apply 1 review criteria
4. Generate markdown report with findings
...
Note: Full AI analysis integration coming in build completion.
 ...
 ✓ src/commands/review.integration.test.ts (5 tests) 333ms
 ✓ src/lib/ship-service.test.ts (17 tests) 65ms
 ✓ src/commands/save.test.ts (4 tests) 113ms
(node:73065) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ scripts/create-test-workspace.test.ts (34 tests | 3 skipped) 82ms
 ✓ scripts/cross-platform.test.ts (25 tests) 116ms
...
Warning: Failed to read package.json for test framework detection: Cannot read properties of undefined (reading 'dependencies')
 ...
 ✓ src/test/context-aware-commands.test.ts (8 tests) 45ms
 ✓ src/commands/hodge-325.smoke.test.ts (13 tests) 146ms
 ✓ src/commands/hodge-319.1.smoke.test.ts (8 tests) 27ms
...
Warning: Failed to read package.json for test framework detection: Invalid JSON
 ...
 ✓ src/lib/detection.test.ts (37 tests) 188ms
 ✓ src/commands/hodge-319.2.smoke.test.ts (10 tests) 43ms
 ✓ src/lib/hodge-md-generator.test.ts (12 tests) 113ms
 ✓ src/lib/pm/env-validator.test.ts (13 tests) 13ms
 ✓ src/lib/hodge-319.3.smoke.test.ts (14 tests) 16ms
 ✓ src/commands/hodge-324.smoke.test.ts (14 tests) 64ms
 ✓ src/test/commonjs-compatibility.integration.test.ts (6 tests) 105ms
 ✓ src/lib/pm/pm-adapter.test.ts (14 tests) 6ms
(node:73135) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/lib/pm/linear-adapter.smoke.test.ts (6 tests) 5ms
 ✓ src/lib/pm/base-adapter.test.ts (16 tests) 52ms
 ✓ src/lib/logger.smoke.test.ts (9 tests) 191ms
 ✓ src/test/documentation-hierarchy.smoke.test.ts (4 tests) 4ms
 ✓ src/lib/esm-config.smoke.test.ts (5 tests) 6ms
 ✓ src/test/test-isolation.integration.test.ts (4 tests) 21ms
...
🚀 Next steps:
 ...
 ✓ src/commands/init.test.ts (5 tests) 29ms
 ...
 ✓ src/lib/harden-service.test.ts (8 tests) 9ms
 ✓ src/commands/save-load.basic.integration.test.ts (5 tests) 3ms
 ✓ src/lib/standards-validator.test.ts (7 tests) 18ms
 ✓ src/test/test-isolation.smoke.test.ts (3 tests) 2ms
 ✓ src/lib/save-service.test.ts (8 tests) 3ms
(node:73206) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ...
 ✓ src/test/hodge-328.smoke.test.ts (5 tests) 11ms
(node:73227) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ↓ src/commands/build.test.ts (6 tests | 6 skipped)
(node:73236) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ↓ src/commands/harden.test.ts (4 tests | 4 skipped)
(node:73233) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ↓ src/commands/explore.test.ts (6 tests | 6 skipped)
 ✓ scripts/sync-claude-commands.test.ts (6 tests) 17932ms
   ✓ sync-claude-commands > [smoke] should generate valid TypeScript  2552ms
   ✓ sync-claude-commands > [smoke] should generate properly formatted code  4804ms
   ✓ sync-claude-commands > [smoke] should complete within reasonable time  2802ms
   ✓ sync-claude-commands > [smoke] should preserve command content  2084ms
   ✓ sync-claude-commands > [smoke] should generate consistent output across runs  3787ms
   ✓ sync-claude-commands > [smoke] should handle prettier formatting gracefully  1900ms

 Test Files  89 passed | 5 skipped (94)
      Tests  795 passed | 41 skipped (836)
   Start at  17:56:11
   Duration  19.37s (transform 3.67s, setup 0ms, collect 27.08s, tests 76.74s, environment 28ms, prepare 20.44s)
