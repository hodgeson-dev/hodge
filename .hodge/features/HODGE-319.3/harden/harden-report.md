...
Quick Actions:
 ...
 ✓ src/commands/save-load.integration.test.ts (5 tests) 1053ms
   ✓ Save/Load Commands [integration] > should list saves correctly  308ms
stdout | src/commands/ship.integration.test.ts > Ship Command - Integration Tests > [integration] should fallback to default message when no state exists
...
✓ Added HODGE-001 to project management tracking
 ...
 ✓ src/lib/pm/pm-hooks.smoke.test.ts (10 tests) 982ms
...
✓ Added HODGE-001 to project management tracking
 ...
 ✓ src/commands/explore.new-style.test.ts (12 tests) 1170ms
stdout | src/commands/ship.integration.test.ts > Ship Command - Integration Tests > [integration] should handle corrupted state gracefully and fallback
   ✓ Commit created successfully
...
stdout | src/commands/ship.integration.test.ts > Ship Command - Integration Tests > [integration] should create ship record and release notes
 ...
 ✓ src/lib/esm-config.integration.test.ts (6 tests) 2097ms
   ✓ ESM Configuration Integration - HODGE-318 > [integration] should run vitest without ERR_REQUIRE_ESM errors  1943ms
stdout | src/commands/ship.integration.test.ts > Ship Command - Integration Tests > [integration] should create ship record and release notes
   Branch: main
...
✓ Added TEST-004 to project management tracking
 ...
 ✓ src/test/pm-hooks.smoke.test.ts (5 tests) 205ms
...
✓ Added CONCURRENT-005 to project management tracking
 ...
 ✓ src/commands/context.smoke.test.ts (8 tests) 2222ms
   ✓ ContextCommand - HODGE-297 Enhanced Loading > [smoke] should execute context command without crashing  696ms
   ✓ ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should use session feature for mode detection when session exists  527ms
   ✓ ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should fall back to general when no session exists  569ms
   ✓ ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should detect build mode correctly for session feature  384ms
stdout | src/lib/pm/local-pm-adapter-unified.integration.test.ts > LocalPMAdapter Unified Architecture Integration Tests > [integration] should properly serialize concurrent operations
...
ℹ️  Created project_management.md with project plan
 ...
 ✓ src/commands/ship.integration.test.ts (5 tests) 2124ms
   ✓ Ship Command - Integration Tests > [integration] should complete full ship workflow with pre-approved message  466ms
   ✓ Ship Command - Integration Tests > [integration] should fallback to default message when no state exists  496ms
   ✓ Ship Command - Integration Tests > [integration] should handle corrupted state gracefully and fallback  419ms
   ✓ Ship Command - Integration Tests > [integration] should create ship record and release notes  324ms
   ✓ Ship Command - Integration Tests > [integration] should skip push to protected branch without prompting  419ms
stdout | src/lib/pm/local-pm-adapter.test.ts > LocalPMAdapter > [smoke] should preserve project plan structure
✓ Added TEST-003 to project management tracking
...
✓ Updated TEST-005 status to: shipped
 ...
 ✓ src/lib/pm/local-pm-adapter.test.ts (10 tests) 203ms
...
✓ Updated TEST-004 status to: building
 ...
 ✓ src/lib/pm/local-pm-adapter-unified.integration.test.ts (7 tests) 732ms
...
📂 Showing status for HODGE-319.3 from session

📊 Status for feature: HODGE-319.3
...
stdout | src/commands/plan.test.ts > PlanCommand - Smoke Tests > [smoke] should accept --create-pm flag without crashing
✓ Created PM issue: bf879375-8425-44fd-830c-27f0e844e6ad
...
Next Steps:
 ...
 ✓ src/commands/plan.test.ts (12 tests) 2441ms
   ✓ PlanCommand - Smoke Tests > [smoke] should accept --create-pm flag without crashing  2360ms
...
✓ Updated TEST-010 status to: hardening
 ...
 ✓ src/lib/pm/local-pm-adapter-unified.smoke.test.ts (12 tests) 879ms
 ✓ src/lib/logger.smoke.test.ts (9 tests) 389ms
   ✓ [smoke] Logger > [smoke] should create LogRotator without crashing  351ms
...
⚠️  No work found for this feature.
 ...
 ✓ src/commands/status.smoke.test.ts (6 tests) 474ms
(node:59866) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/commands/ship-clean-tree.integration.test.ts (4 tests) 362ms
   ✓ ship command integration - HODGE-220 > [integration] should have backup and restore functions integrated  329ms
(node:59891) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/commands/ship-clean-tree.smoke.test.ts (3 tests) 371ms
   ✓ ship command - clean working tree > [smoke] should have rollback functions defined  366ms
...
stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should create auto-save when switching features
📦 Auto-saved: old-feature → /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759514090710-dfad68ae/.hodge/saves/auto-old-feature-2025-10-03T17-54-50 (39ms)

 ✓ src/test/ship-lessons.smoke.test.ts (5 tests) 314ms
...
stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should preserve context in auto-save
📦 Auto-saved: old-feature → /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759514090754-701a725d/.hodge/saves/auto-old-feature-2025-10-03T17-54-50 (37ms)
...
stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should use auto- prefix for save names
📦 Auto-saved: test-feature → /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759514090801-d8e42084/.hodge/saves/auto-test-feature-2025-10-03T17-54-50 (40ms)

 ✓ src/commands/ship-commit-messages.integration.test.ts (4 tests) 334ms
...
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/test/commonjs-compatibility.smoke.test.ts (3 tests) 470ms
   ✓ CommonJS Compatibility [smoke] > should import inquirer without warnings in CommonJS  322ms
...
Auto-save failed for old-feature: EACCES: permission denied, mkdir '/var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759514090861-c2fe8b8f/.hodge/saves/auto-old-feature-2025-10-03T17-54-50'
 ...
 ✓ src/lib/__tests__/auto-save.test.ts (10 tests) 260ms
...
✓ Added TEST-FEATURE to project management tracking
 ...
 ✓ src/lib/id-manager.test.ts (27 tests) 370ms
...
✓ Updated HISTORY-TEST status to: shipped
 ...
 ✓ src/lib/config-defaults.smoke.test.ts (5 tests) 283ms
stdout | src/lib/pm/integration.test.ts > PM Integration Tests > [integration] should track feature history correctly
✓ Updated project plan phase progress
...
✓ Updated project management tracking
 ...
 ✓ src/lib/pm/integration.test.ts (7 tests) 299ms
 ✓ src/lib/config-cleanup.smoke.test.ts (5 tests) 185ms
 ✓ src/test/documentation-hierarchy.integration.test.ts (2 tests) 176ms
...
stdout | test/pm-integration.smoke.test.ts > [smoke] DecideCommand should record decisions without PM integration
 ...
 ✓ src/commands/plan.smoke.test.ts (11 tests) 128ms
...
✓ Updated test-feature status to: building
 ...
 ✓ test/pm-integration.smoke.test.ts (13 tests) 140ms
stdout | src/lib/pm/pm-hooks-integration.test.ts > PM Hooks Integration > [smoke] PM hooks should handle missing configuration gracefully
✓ Updated test-feature status to: shipped
...
✓ Updated project management tracking
 ...
 ✓ src/lib/pm/pm-hooks-integration.test.ts (6 tests) 164ms
...
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/lib/metadata-clarity.smoke.test.ts (5 tests) 156ms
...
✓ Decision recorded successfully
 ...
 ✓ test/pm-integration.integration.test.ts (6 tests) 142ms
...
Exploration saved to: .hodge/features/feature-1/explore
 ...
 ✓ src/commands/decide.smoke.test.ts (5 tests) 92ms
stdout | src/commands/explore-timing-fix.integration.test.ts > [integration] Explore Command Timing Fix > [integration] multiple explores complete successfully
🔍 Entering Explore Mode (Enhanced)
Feature: feature-2
...
✓ Linked to linear issue: feature-2
 ...
 ✓ src/lib/claude-commands.smoke.test.ts (13 tests) 41ms
stdout | src/commands/explore-timing-fix.integration.test.ts > [integration] Explore Command Timing Fix > [integration] multiple explores complete successfully
✓ Enhanced exploration environment created
...
Exploration saved to: .hodge/features/feature-2/explore
 ...
 ✓ src/commands/explore-timing-fix.integration.test.ts (2 tests) 81ms
 ✓ scripts/cross-platform.test.ts (25 tests) 76ms
...
Warning: Failed to read package.json for test framework detection: Invalid JSON
 ...
 ✓ src/lib/pm/github-adapter.smoke.test.ts (4 tests) 36ms
 ✓ src/lib/install-hodge-way.test.ts (6 tests) 117ms
 ✓ scripts/create-test-workspace.test.ts (34 tests | 3 skipped) 76ms
...
✓ Loaded feature spec from /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-ua992/test-spec.yaml
...
✓ Loaded feature spec from /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-0llfv/minimal-spec.yaml

 ✓ src/lib/cache-manager.test.ts (28 tests) 69ms
 ✓ src/lib/__tests__/feature-spec-loader.test.ts (15 tests) 109ms
...
Warning: Failed to load context.json: SyntaxError: Expected property name or '}' in JSON at position 2 (line 1 column 3)
 ...
 ✓ src/lib/__tests__/context-manager.test.ts (9 tests) 165ms
 ✓ src/commands/ship-commit-messages.smoke.test.ts (5 tests) 19ms
...
✓ Updated project management tracking
 ...
 ✓ test/commands/hodge-context-loading.test.ts (4 tests) 17ms
...
✓ Updated project management tracking
 ...
 ✓ src/lib/config-manager.integration.test.ts (6 tests) 84ms
...
✓ Added CUSTOM-STATUS to project management tracking
 ...
 ✓ src/lib/pm/pm-hooks.integration.test.ts (5 tests) 168ms
 ✓ src/lib/hodge-md-generator.test.ts (12 tests) 12ms
 ✓ src/commands/ship-lessons.test.ts (5 tests) 154ms
 ...
 ✓ src/lib/config-manager.smoke.test.ts (10 tests) 51ms
...
🚀 Next steps:
 ...
 ✓ src/commands/init.test.ts (5 tests) 65ms
 ...
 ✓ src/lib/hodge-319.3.smoke.test.ts (14 tests) 15ms
 ✓ src/lib/claude-commands-conversational.smoke.test.ts (6 tests) 110ms
...
(Use `node --trace-deprecation ...` to show where the warning was created)
 ...
 ✓ src/commands/ship.smoke.test.ts (5 tests) 7619ms
   ✓ Ship Command - Smoke Tests > [smoke] should not crash when executed without state  2545ms
   ✓ Ship Command - Smoke Tests > [smoke] should detect and use pre-approved message from state  1501ms
   ✓ Ship Command - Smoke Tests > [smoke] should be completely non-interactive  1676ms
   ✓ Ship Command - Smoke Tests > [smoke] should handle corrupted state files gracefully  1287ms
   ✓ Ship Command - Smoke Tests > [smoke] should be non-interactive by default (no prompts allowed)  609ms
 ↓ src/lib/save-performance.test.ts (5 tests | 5 skipped)
 ✓ scripts/sync-claude-commands.test.ts (6 tests) 7680ms
   ✓ sync-claude-commands > [smoke] should generate valid TypeScript  903ms
   ✓ sync-claude-commands > [smoke] should generate properly formatted code  1980ms
   ✓ sync-claude-commands > [smoke] should complete within reasonable time  1060ms
   ✓ sync-claude-commands > [smoke] should preserve command content  992ms
   ✓ sync-claude-commands > [smoke] should generate consistent output across runs  1774ms
   ✓ sync-claude-commands > [smoke] should handle prettier formatting gracefully  970ms
