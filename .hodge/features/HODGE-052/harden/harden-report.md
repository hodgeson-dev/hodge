...
Failed to analyze src/error-file.ts: Error: File read error
 ...
 ✓ src/lib/pattern-learner.test.ts  (14 tests) 28ms
...
Warning: Failed to read package.json for test framework detection: Invalid JSON
 ...
 ✓ src/lib/detection.test.ts  (37 tests) 41ms
stdout | src/lib/__tests__/feature-spec-loader.test.ts > [unit] FeatureSpecLoader > loadSpec > should load a valid YAML spec
✓ Loaded feature spec from /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-oqzyto/test-spec.yaml
...
✓ Loaded feature spec from /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-mefh2/minimal-spec.yaml

 ✓ scripts/create-test-workspace.test.ts  (34 tests | 3 skipped) 66ms
 ✓ src/lib/__tests__/feature-spec-loader.test.ts  (15 tests) 73ms
...
📦 Auto-saved: old-feature → .hodge/saves/auto-old-feature-2025-09-18T17-42-02
...
📦 Auto-saved: test-feature → .hodge/saves/auto-test-feature-2025-09-18T17-42-02
...
Auto-save failed for old-feature: EACCES: permission denied, mkdir '/Users/michaelkelly/Projects/hodge/.test-hodge/.hodge/saves/auto-old-feature-2025-09-18T17-42-02'
 ...
 ✓ src/lib/__tests__/auto-save.test.ts  (10 tests) 43ms
...
📋 Checking linear for issue HODGE-081...

stdout | src/commands/explore.new-style.test.ts > ExploreCommand > Smoke Tests > [smoke] should not crash with valid input
✓ Linked to linear issue: HODGE-081

 ✓ src/lib/pm/pm-adapter.test.ts  (14 tests) 6ms
 ✓ src/lib/session-manager.test.ts  (11 tests) 68ms
stdout | src/commands/explore.new-style.test.ts > ExploreCommand > Smoke Tests > [smoke] should not crash with valid input
...
Files created:
  • .hodge/features/HODGE-081/explore/exploration.md
  • .hodge/features/HODGE-081/explore/context.json
...
📋 Checking linear for issue HODGE-082...

 ↓ src/commands/harden.test.ts  (5 tests | 5 skipped)
stdout | src/commands/explore.new-style.test.ts > ExploreCommand > Smoke Tests > [smoke] should complete quickly
✓ Linked to linear issue: HODGE-082
...
Files created:
  • .hodge/features/HODGE-082/explore/exploration.md
  • .hodge/features/HODGE-082/explore/context.json
...
🚀 Next steps:
 ...
 ✓ src/commands/init.test.ts  (5 tests) 39ms
...
- Creating Hodge structure...
✔ Hodge structure created successfully
 ✓ src/commands/explore.new-style.test.ts  (12 tests) 1433ms
