...
(node:32271) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
...
1. auto-HODGE-314-2025-10-02T19-24-35 (13 hours ago)
   Feature: HODGE-314, Mode: ship
2. auto-HODGE-314-2025-10-02T19-24-38 (13 hours ago)
   Feature: HODGE-314, Mode: ship
3. auto-HODGE-314-2025-10-02T20-18-50 (13 hours ago)
   Feature: HODGE-314, Mode: ship
4. auto-HODGE-313-2025-10-02T07-09-52 (15 hours ago)
   Feature: HODGE-313, Mode: ship
5. auto-HODGE-313-2025-10-02T07-10-04 (15 hours ago)
   Feature: HODGE-313, Mode: ship
...
stdout | src/commands/plan.test.ts > PlanCommand - Smoke Tests > [smoke] should accept --create-pm flag without crashing
✓ Created PM issue: c325f94f-19fa-448e-adc7-c4113ab04e20
...
Next Steps:
 ...
 ✓ src/commands/plan.test.ts (12 tests) 1759ms
   ✓ PlanCommand - Smoke Tests > [smoke] should accept --create-pm flag without crashing  1572ms
stdout | src/commands/context.smoke.test.ts > ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should detect build mode correctly for session feature
...
Context loaded. Ready to work!
 ...
 ✓ src/commands/context.smoke.test.ts (8 tests) 2358ms
   ✓ ContextCommand - HODGE-297 Enhanced Loading > [smoke] should execute context command without crashing  898ms
   ✓ ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should use session feature for mode detection when session exists  375ms
   ✓ ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should fall back to general when no session exists  609ms
   ✓ ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should detect build mode correctly for session feature  371ms
...
✓ Session saved successfully
  ...
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-5754dd908f938f95/.hodge/saves/integration-test-save
  Time: 37ms
  Type: Full save
...
(node:32545) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
✓ Session saved successfully
  ...
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-14baac714a93269c/.hodge/saves/minimal-integration-test
  Time: 23ms
...
✓ Session saved successfully
  Name: list-test-1
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-51997fe51d6213fc/.hodge/saves/list-test-1
  Time: 24ms
  Type: Full save
...
stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should list saves correctly
✓ Save complete in 102ms

stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should list saves correctly
✓ Session saved successfully
  Name: list-test-2
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-51997fe51d6213fc/.hodge/saves/list-test-2
  Time: 102ms
  Type: Full save
...
✓ Session saved successfully
  Name: list-test-3
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-51997fe51d6213fc/.hodge/saves/list-test-3
  Time: 42ms
  Type: Minimal (manifest only)
...
✓ Session saved successfully
  Name: old-save
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-d9e62ca6cd590d32/.hodge/saves/old-save
  Time: 47ms
  Type: Full save
...
stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should load most recent save automatically
✓ Save complete in 112ms

stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should load most recent save automatically
✓ Session saved successfully
  Name: recent-save
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-d9e62ca6cd590d32/.hodge/saves/recent-save
  Time: 113ms
  Type: Full save
...
✓ Session saved successfully
  ...
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-8ed0f1fe89c1f0a7/.hodge/saves/metadata-test-save
  Time: 67ms
  Type: Full save
...
Quick Actions:
 ...
 ✓ src/commands/save-load.integration.test.ts (5 tests) 1327ms
   ✓ Save/Load Commands [integration] > should list saves correctly  379ms
   ✓ Save/Load Commands [integration] > should load most recent save automatically  363ms
...
✓ Updated project management tracking
 ...
 ✓ src/lib/pm/pm-hooks.smoke.test.ts (10 tests) 1171ms
   ✓ PM Hooks Smoke Tests > [smoke] should load configuration from hodge.json  338ms
...
ℹ️  Created project_management.md with project plan
 ...
 ✓ src/commands/explore-timing-fix.integration.test.ts (2 tests) 4916ms
   ✓ [integration] Explore Command Timing Fix > [integration] explore command completes within reasonable time  2058ms
   ✓ [integration] Explore Command Timing Fix > [integration] multiple explores complete within time limit  2857ms
...
✓ Added TEST-002 to project management tracking
 ...
 ✓ src/commands/ship.smoke.test.ts (5 tests) 5137ms
   ✓ Ship Command - Smoke Tests > [smoke] should not crash when executed without state  1178ms
   ✓ Ship Command - Smoke Tests > [smoke] should detect and use pre-approved message from state  966ms
   ✓ Ship Command - Smoke Tests > [smoke] should be completely non-interactive  1296ms
   ✓ Ship Command - Smoke Tests > [smoke] should handle corrupted state files gracefully  1349ms
   ✓ Ship Command - Smoke Tests > [smoke] should be non-interactive by default (no prompts allowed)  347ms
...
ℹ️  Created project_management.md with project plan
 ...
 ✓ src/test/commonjs-compatibility.integration.test.ts (3 tests) 5149ms
   ✓ CommonJS Compatibility [integration] > should execute full hodge workflow without CommonJS warnings  2228ms
   ✓ CommonJS Compatibility [integration] > should handle all primary commands without warnings  2798ms
stdout | src/lib/pm/local-pm-adapter-unified.integration.test.ts > LocalPMAdapter Unified Architecture Integration Tests > [integration] should properly serialize concurrent operations
...
✓ Updated NONEXISTENT-002 status to: building
 ...
 ✓ src/lib/pm/local-pm-adapter-unified.integration.test.ts (7 tests) 583ms
...
✓ Updated TEST-010 status to: hardening
 ...
 ✓ src/lib/pm/local-pm-adapter-unified.smoke.test.ts (12 tests) 808ms
...
⚠️  No work found for this feature.
 ...
 ✓ src/commands/status.smoke.test.ts (6 tests) 346ms
 ✓ src/lib/logger.smoke.test.ts (9 tests) 151ms
(node:32933) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/test/ship-lessons.smoke.test.ts (5 tests) 425ms
   ✓ [smoke] Ship Lessons Generation > [smoke] ship command should have generateLessonsDraft method  414ms
 ✓ src/test/commonjs-compatibility.smoke.test.ts (3 tests) 422ms
(node:33032) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
✓ Added TEST-001 to project management tracking
 ...
 ✓ src/lib/id-manager.test.ts (27 tests) 440ms
(node:33042) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
✓ Save complete in 211ms

stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should create auto-save when switching features
📦 Auto-saved: old-feature → /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759440198543-2ce10ce8/.hodge/saves/auto-old-feature-2025-10-02T21-23-18 (212ms)

 ✓ src/commands/ship-clean-tree.integration.test.ts (4 tests) 486ms
   ✓ ship command integration - HODGE-220 > [integration] should have backup and restore functions integrated  480ms
...
stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should preserve context in auto-save
📦 Auto-saved: old-feature → /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759440198757-8e2440fb/.hodge/saves/auto-old-feature-2025-10-02T21-23-18 (41ms)
...
stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should use auto- prefix for save names
📦 Auto-saved: test-feature → /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759440198864-ed369c12/.hodge/saves/auto-test-feature-2025-10-02T21-23-18 (89ms)
...
✓ Added TEST-004 to project management tracking
 ...
 ✓ src/commands/ship.integration.test.ts (5 tests) 6682ms
   ✓ Ship Command - Integration Tests > [integration] should complete full ship workflow with pre-approved message  1238ms
   ✓ Ship Command - Integration Tests > [integration] should fallback to default message when no state exists  1535ms
   ✓ Ship Command - Integration Tests > [integration] should handle corrupted state gracefully and fallback  1408ms
   ✓ Ship Command - Integration Tests > [integration] should create ship record and release notes  1324ms
   ✓ Ship Command - Integration Tests > [integration] should skip push to protected branch without prompting  1174ms
stderr | src/lib/__tests__/auto-save.test.ts > AutoSave > Error Handling > [integration] should continue even if save fails
Auto-save failed for old-feature: EACCES: permission denied, mkdir '/var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759440198974-a0138e24/.hodge/saves/auto-old-feature-2025-10-02T21-23-18'

 ✓ src/lib/__tests__/auto-save.test.ts (10 tests) 517ms
 ✓ src/test/pm-hooks.smoke.test.ts (5 tests) 520ms
   ✓ [smoke] PMHooks should handle missing configuration gracefully  307ms
 ✓ src/test/documentation-hierarchy.integration.test.ts (2 tests) 269ms
(node:33132) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/commands/ship-clean-tree.smoke.test.ts (3 tests) 243ms
(node:33147) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/commands/ship-commit-messages.integration.test.ts (4 tests) 404ms
...
stdout | src/lib/pm/pm-hooks.integration.test.ts > PMHooks Integration Tests > [integration] should silently handle external PM failures
 ...
 ✓ src/lib/config-cleanup.smoke.test.ts (5 tests) 178ms
...
✓ Added CUSTOM-STATUS to project management tracking
 ...
 ✓ src/lib/pm/pm-hooks.integration.test.ts (5 tests) 122ms
stdout | src/lib/pm/integration.test.ts > PM Integration Tests > [integration] should handle HODGE-006 specifically
...
✓ Updated project management tracking
 ...
 ✓ src/lib/pm/integration.test.ts (7 tests) 517ms
 ✓ src/lib/install-hodge-way.test.ts (6 tests) 160ms
 ✓ src/test/standards-enforcement.integration.test.ts (2 tests) 157ms
 ✓ src/lib/metadata-clarity.smoke.test.ts (5 tests) 211ms
...
(node:33205) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
stdout | src/lib/pm/local-pm-adapter.test.ts > LocalPMAdapter > [smoke] should preserve project plan structure
✓ Updated TEST-003 status to: building
...
✓ Updated TEST-005 status to: shipped
 ...
 ✓ src/lib/pm/local-pm-adapter.test.ts (10 tests) 282ms
stdout | src/lib/__tests__/feature-spec-loader.test.ts > [unit] FeatureSpecLoader > loadSpec > should load a valid YAML spec
✓ Loaded feature spec from /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-pis2zz8/test-spec.yaml
...
✓ Loaded feature spec from /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-hyks1/minimal-spec.yaml
...
✓ Added test-feature to project management tracking
 ...
 ✓ src/lib/__tests__/feature-spec-loader.test.ts (15 tests) 57ms
stdout | src/lib/pm/pm-hooks-integration.test.ts > PM Hooks Integration > [smoke] PM hooks should handle missing configuration gracefully
...
✓ Updated project management tracking
 ...
 ✓ src/lib/pm/pm-hooks-integration.test.ts (6 tests) 147ms
 ✓ src/commands/save.test.ts (4 tests) 25ms
(node:33238) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ scripts/sync-claude-commands.test.ts (6 tests) 8427ms
   ✓ sync-claude-commands > [smoke] should generate valid TypeScript  1232ms
   ✓ sync-claude-commands > [smoke] should generate properly formatted code  1902ms
   ✓ sync-claude-commands > [smoke] should complete within reasonable time  1174ms
   ✓ sync-claude-commands > [smoke] should preserve command content  1158ms
   ✓ sync-claude-commands > [smoke] should generate consistent output across runs  1818ms
   ✓ sync-claude-commands > [smoke] should handle prettier formatting gracefully  1142ms
stdout | test/pm-integration.integration.test.ts > [integration] PM integration: decide command creates issues after decisions
📝 Recording Decision

(node:33246) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
stdout | test/pm-integration.integration.test.ts > [integration] PM integration: decide command creates issues after decisions
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759440200736/.hodge/features/TEST-001/decisions.md
  Feature: TEST-001
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759440200866-ctetsk/.hodge/features/HODGE-301/decisions.md
  Feature: HODGE-301

stdout | test/pm-integration.smoke.test.ts > [smoke] DecideCommand should record decisions without PM integration
  Total decisions: 1

 ✓ src/commands/load.test.ts (4 tests) 202ms
stdout | test/pm-integration.integration.test.ts > [integration] PM integration: plan command analyzes decisions
📋 Planning Work Structure

 ✓ test/pm-integration.smoke.test.ts (13 tests) 320ms
 ✓ src/lib/claude-commands.smoke.test.ts (8 tests) 100ms
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759440201156/.hodge/features/TEST-001/decisions.md
  Feature: TEST-001
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759440201178/.hodge/decisions.md
  Total decisions: 1
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759440201182/.hodge/features/TEST-002/decisions.md
  Feature: TEST-002
...
✗ Error: Feature directory does not exist
  Expected: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759440201187/.hodge/features/NONEXISTENT
...
Next Steps:
 ...
 ✓ test/pm-integration.integration.test.ts (6 tests) 481ms
 ✓ src/lib/pm/github-adapter.smoke.test.ts (4 tests) 143ms
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759440201269/.hodge/features/TEST-003/decisions.md
  Feature: TEST-003

stdout | src/commands/decide.smoke.test.ts > Decide Command --feature Flag (HODGE-313) > [smoke] Feature decisions file uses correct template format
  Total decisions: 1

 ✓ src/commands/decide.smoke.test.ts (5 tests) 274ms
 ✓ src/lib/config-manager.smoke.test.ts (10 tests) 12ms
(node:33324) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/commands/ship-commit-messages.smoke.test.ts (5 tests) 171ms
...
Warning: Failed to load context.json: SyntaxError: Expected property name or '}' in JSON at position 2 (line 1 column 3)
 ...
 ✓ src/lib/__tests__/context-manager.test.ts (9 tests) 75ms
 ✓ src/lib/config-manager.integration.test.ts (6 tests) 45ms
(node:33366) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
[90m    at processTicksAndRejections (node:internal/process/task_queues:105:5)[39m
 ...
 ✓ src/lib/config-defaults.smoke.test.ts (5 tests) 164ms
 ✓ scripts/create-test-workspace.test.ts (34 tests | 3 skipped) 237ms
 ✓ src/lib/pattern-learner.test.ts (14 tests) 40ms
 ✓ scripts/cross-platform.test.ts (25 tests) 95ms
(node:33388) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
- Detecting project configuration...
✔ Project detection complete
- Creating Hodge structure...
...
🚀 Next steps:
 ...
 ✓ src/commands/ship-lessons.test.ts (5 tests) 78ms
- Detecting project configuration...
✔ Project detection complete
...
🚀 Next steps:
 ...
 ✓ src/lib/pm/base-adapter.test.ts (16 tests) 37ms
 ✓ test/commands/hodge-context-loading.test.ts (4 tests) 21ms
 ✓ src/commands/init.test.ts (5 tests) 58ms
 ✓ src/lib/hodge-md-generator.test.ts (12 tests) 19ms
 ✓ src/lib/structure-generator.test.ts (27 tests) 142ms
 ✓ src/lib/pm/env-validator.test.ts (13 tests) 10ms
(node:33410) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ...
 ✓ src/lib/pm/index.test.ts (10 tests) 24ms
 ✓ test/pre-push-hook.test.ts (10 tests) 5ms
 ✓ src/test/explore-no-approach-generation.smoke.test.ts (5 tests) 7ms
 ✓ src/commands/plan.smoke.test.ts (11 tests) 279ms
 ✓ src/lib/standards-validator.test.ts (7 tests) 3ms
(node:33464) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
(node:33479) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
(node:33487) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ↓ src/commands/build.test.ts (7 tests | 7 skipped)
(node:33489) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
(Use `node --trace-deprecation ...` to show where the warning was created)
 ...
 ✓ src/commands/explore.new-style.test.ts (12 tests) 17338ms
   ✓ ExploreCommand > Smoke Tests > [smoke] should not crash with valid input  1052ms
   ✓ ExploreCommand > Smoke Tests > [smoke] should complete quickly  1074ms
   ✓ ExploreCommand > Integration Tests > [integration] should create exploration structure  1559ms
   ✓ ExploreCommand > Integration Tests > [integration] should detect existing exploration  3621ms
   ✓ ExploreCommand > Integration Tests > [integration] should create test intentions file  1430ms
   ✓ ExploreCommand > Integration Tests > [integration] should integrate with PM tools when configured  2842ms
   ✓ ExploreCommand > Acceptance Tests > [acceptance] should support complete exploration workflow  2646ms
   ✓ ExploreCommand > ExploreCommand (Real FS) > [integration] should work with real file system  2898ms
 ✓ src/test/test-isolation.integration.test.ts (4 tests) 17953ms
   ✓ [integration] Test Isolation > [integration] should handle parallel test execution without conflicts  7198ms
   ✓ [integration] Test Isolation > [integration] should maintain complete isolation between test runs  6011ms
   ✓ [integration] Test Isolation > [integration] should prevent test data from leaking into project  4564ms

 Test Files  74 passed | 5 skipped (79)
      Tests  652 passed | 43 skipped (695)
   Start at  14:23:11
   Duration  18.59s (transform 1.69s, setup 0ms, collect 11.85s, tests 83.00s, environment 28ms, prepare 10.33s)
...
✖ 260 problems (0 errors, 260 warnings)
