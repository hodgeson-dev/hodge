...
(node:86621) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
...
1. auto-HODGE-317.1-2025-10-02T23-03-09 (6 hours ago)
   Feature: HODGE-317.1, Mode: ship
2. auto-HODGE-317.1-2025-10-02T23-38-57 (6 hours ago)
   Feature: HODGE-317.1, Mode: ship
3. auto-HODGE-318-2025-10-02T22-18-50 (7 hours ago)
   Feature: HODGE-318, Mode: explore
4. auto-HODGE-316-2025-10-02T22-15-45 (7 hours ago)
   Feature: HODGE-316, Mode: ship
5. auto-HODGE-317-2025-10-02T21-57-46 (7 hours ago)
   Feature: HODGE-317, Mode: explore
...
stdout | src/commands/plan.test.ts > PlanCommand - Smoke Tests > [smoke] should accept --create-pm flag without crashing
✓ Created PM issue: aed7de27-a143-496b-a63a-05238c8b664d
...
Next Steps:
 ...
 ✓ src/commands/plan.test.ts (12 tests) 1140ms
   ✓ PlanCommand - Smoke Tests > [smoke] should accept --create-pm flag without crashing  925ms
stdout | src/commands/context.smoke.test.ts > ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should use session feature for mode detection when session exists
...
✓ Session saved successfully
  ...
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-3f1e8f8b874275f0/.hodge/saves/integration-test-save
  Time: 35ms
  Type: Full save
...
✓ Manifest loaded in 1ms
 ...
 ✓ src/lib/esm-config.integration.test.ts (6 tests) 2360ms
   ✓ ESM Configuration Integration - HODGE-318 > [integration] should run vitest without ERR_REQUIRE_ESM errors  2081ms
stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should save and load a session successfully
...
✓ Session saved successfully
  ...
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-14c8574c4e04fb64/.hodge/saves/minimal-integration-test
  Time: 28ms
...
Context loaded. Ready to work!
 ...
 ✓ src/commands/context.smoke.test.ts (8 tests) 2323ms
   ✓ ContextCommand - HODGE-297 Enhanced Loading > [smoke] should execute context command without crashing  1089ms
   ✓ ContextCommand - HODGE-313 Session-Based Mode Detection > [smoke] should use session feature for mode detection when session exists  622ms
...
✓ Session saved successfully
  Name: list-test-1
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-fa8184e7495c5b47/.hodge/saves/list-test-1
  Time: 52ms
  Type: Full save
...
✓ Session saved successfully
  Name: list-test-2
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-fa8184e7495c5b47/.hodge/saves/list-test-2
  Time: 43ms
  Type: Full save
...
✓ Session saved successfully
  Name: list-test-3
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-fa8184e7495c5b47/.hodge/saves/list-test-3
  Time: 31ms
  Type: Minimal (manifest only)
...
(node:86946) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should load most recent save automatically
✓ Save complete in 69ms

stdout | src/commands/save-load.integration.test.ts > Save/Load Commands [integration] > should load most recent save automatically
✓ Session saved successfully
  Name: old-save
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-15f94db7e74599fd/.hodge/saves/old-save
  Time: 69ms
  Type: Full save
...
✓ Session saved successfully
  Name: recent-save
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-15f94db7e74599fd/.hodge/saves/recent-save
  Time: 35ms
  Type: Full save
...
✓ Session saved successfully
  ...
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-integration-test-a704082fd977e955/.hodge/saves/metadata-test-save
  Time: 26ms
  Type: Full save
...
✓ Added TEST-006 to project management tracking
 ...
 ✓ src/commands/save-load.integration.test.ts (5 tests) 1165ms
   ✓ Save/Load Commands [integration] > should list saves correctly  401ms
   ✓ Save/Load Commands [integration] > should load most recent save automatically  345ms
...
✓ Updated TEST-010 status to: hardening
 ...
 ✓ src/lib/pm/local-pm-adapter-unified.smoke.test.ts (12 tests) 820ms
...
✓ Updated project management tracking
 ...
 ✓ src/lib/pm/pm-hooks.smoke.test.ts (10 tests) 734ms
...
✓ Updated NONEXISTENT-002 status to: building
 ...
 ✓ src/test/commonjs-compatibility.smoke.test.ts (3 tests) 311ms
 ✓ src/lib/pm/local-pm-adapter-unified.integration.test.ts (7 tests) 416ms
...
📂 Showing status for HODGE-318 from session

📊 Status for feature: HODGE-318
...
Next Step:
  ...
  hodge decide "Your decision here" --feature HODGE-318
...
⚠️  No work found for this feature.
 ...
 ✓ src/commands/explore-timing-fix.integration.test.ts (2 tests) 4415ms
   ✓ [integration] Explore Command Timing Fix > [integration] explore command completes within reasonable time  1269ms
   ✓ [integration] Explore Command Timing Fix > [integration] multiple explores complete within time limit  3145ms
...
⚠️  No work found for this feature.
 ...
 ✓ src/commands/status.smoke.test.ts (6 tests) 429ms
(node:87248) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
(node:87249) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/commands/ship-clean-tree.smoke.test.ts (3 tests) 334ms
   ✓ ship command - clean working tree > [smoke] should have rollback functions defined  318ms
 ✓ src/test/commonjs-compatibility.integration.test.ts (3 tests) 4990ms
   ✓ CommonJS Compatibility [integration] > should execute full hodge workflow without CommonJS warnings  2545ms
   ✓ CommonJS Compatibility [integration] > should handle all primary commands without warnings  2362ms
 ✓ src/test/ship-lessons.smoke.test.ts (5 tests) 368ms
   ✓ [smoke] Ship Lessons Generation > [smoke] ship command should have generateLessonsDraft method  333ms
(node:87262) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/commands/ship-clean-tree.integration.test.ts (4 tests) 334ms
   ✓ ship command integration - HODGE-220 > [integration] should have backup and restore functions integrated  303ms
(node:87326) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should create auto-save when switching features
📦 Auto-saved: old-feature → /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759469625269-be7f3bea/.hodge/saves/auto-old-feature-2025-10-03T05-33-45 (35ms)
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759469625278-gnm3i5/.hodge/features/HODGE-301/decisions.md
  Feature: HODGE-301
...
stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should preserve context in auto-save
📦 Auto-saved: old-feature → /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759469625307-951d1cb6/.hodge/saves/auto-old-feature-2025-10-03T05-33-45 (32ms)

stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should use auto- prefix for save names
✓ Save complete in 31ms

stdout | src/lib/__tests__/auto-save.test.ts > AutoSave > Behavioral Tests > [unit] should use auto- prefix for save names
📦 Auto-saved: test-feature → /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759469625342-c6fdcf11/.hodge/saves/auto-test-feature-2025-10-03T05-33-45 (31ms)

(node:87342) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/lib/metadata-clarity.smoke.test.ts (5 tests) 160ms
stderr | src/lib/__tests__/auto-save.test.ts > AutoSave > Error Handling > [integration] should continue even if save fails
Auto-save failed for old-feature: EACCES: permission denied, mkdir '/var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759469625382-5a31a817/.hodge/saves/auto-old-feature-2025-10-03T05-33-45'

 ✓ src/lib/__tests__/auto-save.test.ts (10 tests) 173ms
 ✓ src/lib/config-defaults.smoke.test.ts (5 tests) 234ms
(node:87354) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/lib/config-cleanup.smoke.test.ts (5 tests) 92ms
...
✓ Updated project management tracking
 ...
 ✓ src/lib/pm/pm-hooks-integration.test.ts (6 tests) 144ms
 ✓ src/test/documentation-hierarchy.integration.test.ts (2 tests) 145ms
(node:87412) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
✓ Added TEST-FEATURE to project management tracking
 ...
 ✓ src/commands/ship.smoke.test.ts (5 tests) 6050ms
   ✓ Ship Command - Smoke Tests > [smoke] should not crash when executed without state  1227ms
   ✓ Ship Command - Smoke Tests > [smoke] should detect and use pre-approved message from state  1965ms
   ✓ Ship Command - Smoke Tests > [smoke] should be completely non-interactive  1149ms
   ✓ Ship Command - Smoke Tests > [smoke] should handle corrupted state files gracefully  1230ms
   ✓ Ship Command - Smoke Tests > [smoke] should be non-interactive by default (no prompts allowed)  478ms
...
✓ Updated project management tracking
 ...
 ✓ src/lib/pm/integration.test.ts (7 tests) 268ms
(node:87431) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759469626281/.hodge/features/TEST-001/decisions.md
  Feature: TEST-001

 ✓ src/test/standards-enforcement.integration.test.ts (2 tests) 147ms
stdout | test/pm-integration.integration.test.ts > [integration] PM integration: decide command creates issues after decisions
  Total decisions: 1
...
✓ Updated TEST-002 status to: building
 ...
 ✓ test/pm-integration.integration.test.ts (6 tests) 94ms
...
(node:87457) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
✓ Updated TEST-005 status to: shipped
 ...
 ✓ src/lib/pm/local-pm-adapter.test.ts (10 tests) 133ms
 ✓ src/commands/ship-lessons.test.ts (5 tests) 57ms
...
Warning: Failed to load context.json: SyntaxError: Expected property name or '}' in JSON at position 2 (line 1 column 3)
 ...
 ✓ src/lib/__tests__/context-manager.test.ts (9 tests) 26ms
(node:87501) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/lib/install-hodge-way.test.ts (6 tests) 70ms
...
✓ Added TEST-004 to project management tracking
 ...
 ✓ src/test/pm-hooks.smoke.test.ts (5 tests) 150ms
 ✓ src/lib/session-manager.test.ts (11 tests) 172ms
stdout | src/lib/__tests__/feature-spec-loader.test.ts > [unit] FeatureSpecLoader > loadSpec > should load a valid YAML spec
✓ Loaded feature spec from /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-aei8ai/test-spec.yaml

 ✓ src/commands/load.test.ts (4 tests) 13ms
...
✓ Loaded feature spec from /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-wzqi4/minimal-spec.yaml

 ✓ src/lib/pattern-learner.test.ts (14 tests) 18ms
 ✓ src/lib/logger.smoke.test.ts (9 tests) 366ms
   ✓ [smoke] Logger > [smoke] should create LogRotator without crashing  318ms
 ✓ src/lib/__tests__/feature-spec-loader.test.ts (15 tests) 63ms
 ✓ scripts/sync-claude-commands.test.ts (6 tests) 7360ms
   ✓ sync-claude-commands > [smoke] should generate valid TypeScript  1353ms
   ✓ sync-claude-commands > [smoke] should generate properly formatted code  1994ms
   ✓ sync-claude-commands > [smoke] should complete within reasonable time  767ms
   ✓ sync-claude-commands > [smoke] should preserve command content  720ms
   ✓ sync-claude-commands > [smoke] should generate consistent output across runs  1669ms
   ✓ sync-claude-commands > [smoke] should handle prettier formatting gracefully  856ms
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759469627297/.hodge/features/TEST-001/decisions.md
  Feature: TEST-001
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759469627351/.hodge/decisions.md
  Total decisions: 1
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759469627397/.hodge/features/TEST-002/decisions.md
  Feature: TEST-002
...
✗ Error: Feature directory does not exist
  Expected: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759469627423/.hodge/features/NONEXISTENT
...
✓ Decision recorded successfully
  Location: /var/folders/_g/gy5jp17j06s7b882m93tlk140000gn/T/hodge-test-1759469627427/.hodge/features/TEST-003/decisions.md
  Feature: TEST-003

stdout | src/commands/decide.smoke.test.ts > Decide Command --feature Flag (HODGE-313) > [smoke] Feature decisions file uses correct template format
  Total decisions: 1

 ✓ src/commands/decide.smoke.test.ts (5 tests) 145ms
 ✓ src/lib/pm/github-adapter.smoke.test.ts (4 tests) 45ms
(node:87582) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/lib/config-manager.integration.test.ts (6 tests) 24ms
 ✓ src/commands/ship-commit-messages.smoke.test.ts (5 tests) 31ms
 ✓ src/commands/ship.integration.test.ts (5 tests) 7609ms
   ✓ Ship Command - Integration Tests > [integration] should complete full ship workflow with pre-approved message  1934ms
   ✓ Ship Command - Integration Tests > [integration] should fallback to default message when no state exists  1565ms
   ✓ Ship Command - Integration Tests > [integration] should handle corrupted state gracefully and fallback  1065ms
   ✓ Ship Command - Integration Tests > [integration] should create ship record and release notes  1623ms
   ✓ Ship Command - Integration Tests > [integration] should skip push to protected branch without prompting  1421ms
...
✓ Added CONCURRENT-3 to project management tracking
 ...
 ✓ scripts/create-test-workspace.test.ts (34 tests | 3 skipped) 137ms
stdout | src/lib/pm/pm-hooks.integration.test.ts > PMHooks Integration Tests > [integration] should handle concurrent feature updates
...
stdout | src/lib/pm/pm-hooks.integration.test.ts > PMHooks Integration Tests > [integration] should silently handle external PM failures
 ...
 ✓ scripts/cross-platform.test.ts (25 tests) 46ms
 ✓ src/lib/claude-commands.smoke.test.ts (13 tests) 86ms
...
(node:87597) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
stdout | src/lib/pm/pm-hooks.integration.test.ts > PMHooks Integration Tests > [integration] should respect custom status mappings
✓ Added CUSTOM-STATUS to project management tracking

 ✓ src/lib/pm/pm-hooks.integration.test.ts (5 tests) 355ms
 ✓ src/lib/pm/base-adapter.test.ts (16 tests) 36ms
...
Warning: Failed to read package.json for test framework detection: Invalid JSON
 ...
 ✓ src/commands/plan.smoke.test.ts (11 tests) 269ms
 ✓ src/lib/detection.test.ts (37 tests) 79ms
(node:87603) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/lib/esm-config.smoke.test.ts (5 tests) 6ms
 ✓ src/commands/save.test.ts (4 tests) 24ms
 ✓ src/lib/structure-generator.test.ts (27 tests) 23ms
 ✓ src/test/context-aware-commands.test.ts (8 tests) 72ms
 ✓ src/lib/pm/env-validator.test.ts (13 tests) 17ms
 ✓ test/commands/hodge-context-loading.test.ts (4 tests) 29ms
 ✓ src/lib/config-manager.smoke.test.ts (10 tests) 54ms
...
🚀 Next steps:
 ...
 ✓ test/pre-push-hook.test.ts (10 tests) 15ms
 ✓ src/lib/claude-commands-conversational.smoke.test.ts (6 tests) 34ms
...
(node:87653) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ✓ src/commands/explore-enhanced-simple.test.ts (2 tests) 3ms
(node:87645) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
(node:87680) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ↓ src/commands/build.test.ts (7 tests | 7 skipped)
(node:87684) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ↓ src/commands/harden.test.ts (5 tests | 5 skipped)
(node:87686) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
 ↓ src/commands/explore.test.ts (6 tests | 6 skipped)
 ✓ src/commands/explore.new-style.test.ts (12 tests) 12876ms
   ✓ ExploreCommand > Smoke Tests > [smoke] should not crash with valid input  1512ms
   ✓ ExploreCommand > Smoke Tests > [smoke] should complete quickly  1765ms
   ✓ ExploreCommand > Integration Tests > [integration] should create exploration structure  1834ms
   ✓ ExploreCommand > Integration Tests > [integration] should detect existing exploration  3722ms
   ✓ ExploreCommand > Integration Tests > [integration] should create test intentions file  1155ms
   ✓ ExploreCommand > Integration Tests > [integration] should integrate with PM tools when configured  682ms
   ✓ ExploreCommand > Acceptance Tests > [acceptance] should support complete exploration workflow  1273ms
   ✓ ExploreCommand > ExploreCommand (Real FS) > [integration] should work with real file system  780ms

 Test Files  76 passed | 5 skipped (81)
      Tests  668 passed | 43 skipped (711)
   Start at  22:33:39
   Duration  13.54s (transform 1.57s, setup 0ms, collect 9.99s, tests 59.01s, environment 13ms, prepare 8.01s)
...
✖ 264 problems (0 errors, 264 warnings)
